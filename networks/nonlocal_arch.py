...
class MYNONLOCAL(nn.Module):
    def __init__(self, in_channels=32, inter_channels=None, dimension=2, sub_sample=False, bn_layer=False):
        ...
        # self.down = SpaceToDepth(4)  # 对特征图下采样
        # self.up = nn.PixelShuffle(4)  # 对特征图上采样
